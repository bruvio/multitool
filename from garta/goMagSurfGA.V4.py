...
# v.4 04.07.2018
# choose using radio button which flux to use for fluxlines
...
class MagSurf(QtGui.QMainWindow, magSurfGAV4.Ui_MainWindow):
    """
    ...
    def __init__(self, parent=None):
       ...
       #
        ...
        #
        self.EFIT_RB.setChecked(False)
        self.FLUSH_RB.setChecked(True)
        #
    ...
    def goMagSurfGA(self):
        ...
        fluxEFIT = self.EFIT_RB.isChecked()
        fluxFLUSH = self.FLUSH_RB.isChecked()
        ...
        if fluxFLUSH:
            timeFLUSH, ier = Flush.flushquickinit(JPN,timeEquil)

...
class Ui_eqdsk_window(object):
    def setupUi(self, eqdsk_window):
        ...
        eqdsk_window.resize(630, 402)
        self.centralwidget = QtGui.QWidget(eqdsk_window)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.groupBox_3 = QtGui.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(0, 10, 611, 351))
        ...
        self.lineEdit_labelIN = QtGui.QLineEdit(self.groupBox_3)
        self.lineEdit_labelIN.setGeometry(QtCore.QRect(170, 210, 171, 21))
        self.lineEdit_labelIN.setObjectName(_fromUtf8("lineEdit_labelIN"))
        self.lineEdit_labelOUT = QtGui.QLineEdit(self.groupBox_3)
        self.lineEdit_labelOUT.setGeometry(QtCore.QRect(170, 240, 171, 21))
        self.lineEdit_labelOUT.setObjectName(_fromUtf8("lineEdit_labelOUT"))
        self.label = QtGui.QLabel(self.groupBox_3)
        self.label.setGeometry(QtCore.QRect(350, 210, 59, 15))
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtGui.QLabel(self.groupBox_3)
        self.label_2.setGeometry(QtCore.QRect(350, 240, 71, 16))
        ...
        self.lineEdit_labelIN.raise_()
        self.lineEdit_labelOUT.raise_()
        self.label.raise_()
        self.label_2.raise_()
        self.eqdsk_exit.raise_()
        self.pushButton_lcmsmapX.raise_()
        self.groupBox_4 = QtGui.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 180, 411, 171))
        self.groupBox_4.setObjectName(_fromUtf8("groupBox_4"))
        self.pushButton_writemagneticdata = QtGui.QPushButton(self.groupBox_4)
        self.pushButton_writemagneticdata.setGeometry(QtCore.QRect(10, 70, 141, 25))
        ...
        self.checkBox_invert.setGeometry(QtCore.QRect(10, 140, 88, 20))
        self.checkBox_invert.setObjectName(_fromUtf8("checkBox_invert"))
        self.checkBox_normalize = QtGui.QCheckBox(self.groupBox_4)
        self.checkBox_normalize.setGeometry(QtCore.QRect(10, 110, 88, 20))
        ...
        self.pushButton_getmagneticdata.setGeometry(QtCore.QRect(10, 30, 141, 25))
